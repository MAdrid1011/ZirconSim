...
$(UNIT_BINARY): src/DeterministicAxiMemory.cc src/ElfImage.cc tests/UnitTests.cc include/DeterministicAxiMemory.h include/ElfImage.h include/DeterministicRng.h
	@mkdir -p $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) src/DeterministicAxiMemory.cc src/ElfImage.cc tests/UnitTests.cc -o $@
